...
public class Calculadora {
    ...
    private int residuoDecimal;
    private String residuoBinario;
    ...
    public void dividir() throws ArithmeticException {
        ...
        resultadoDecimal = resultado[0]; // Cociente
        residuoDecimal = resultado[1]; // Residuo
        resultadoBinario = Operaciones.toBinaryString(resultadoDecimal, Operaciones.BITS);
        residuoBinario = Operaciones.toBinaryString(residuoDecimal, Operaciones.BITS);
    }
    ...
    public int getResiduoDecimal() {
        return residuoDecimal;
    }

    public String getResiduoBinario() {
        return residuoBinario;
    }
