...
public class CalculadoraUi {
    ...
    private JTextField textResiduoDecimal;
    private JTextField textResiduoBinario;
    ...
    private void initialize() {
        ...
        frame.setBounds(100, 160, 500, 400);
        ...
        JLabel lblResiduoDecimal = new JLabel("Residuo Decimal");
        lblResiduoDecimal.setBounds(10, 225, 113, 14);
        frame.getContentPane().add(lblResiduoDecimal);

        textResiduoDecimal = new JTextField();
        textResiduoDecimal.setBounds(133, 222, 250, 20);
        textResiduoDecimal.setEditable(false);
        frame.getContentPane().add(textResiduoDecimal);
        textResiduoDecimal.setColumns(10);

        JLabel lblResiduoBinario = new JLabel("Residuo Binario");
        lblResiduoBinario.setBounds(10, 250, 113, 14);
        frame.getContentPane().add(lblResiduoBinario);

        textResiduoBinario = new JTextField();
        textResiduoBinario.setBounds(133, 247, 250, 20);
        textResiduoBinario.setEditable(false);
        frame.getContentPane().add(textResiduoBinario);
        textResiduoBinario.setColumns(10);
        ...
        btnDesplazarIzq.setBounds(10, 300, 150, 23);
        ...
        btnDesplazarDer.setBounds(170, 300, 150, 23);
        ...
        try {
            ...
            switch (operacion) {
                ...
                case "dividir":
                    ...
                    textResultadoDecimal.setText(String.valueOf(calculadora.getResultadoDecimal()));
                    textResultadoBinario.setText(calculadora.getResultadoBinario());
                    textResiduoDecimal.setText(String.valueOf(calculadora.getResiduoDecimal()));
                    textResiduoBinario.setText(calculadora.getResiduoBinario());
                    break;
